...
- **Buyer Type**: Hidden in Deal Analyser and Simple Analyser modes (locked to Investor/Additional Property). Only visible in SDLT Calculator Only mode where users can switch between Main Residence, Investor, and First-Time Buyer.
